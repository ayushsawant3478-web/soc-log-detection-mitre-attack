...
- **What happened**: `mimikatz.exe` opened a handle into `lsass.exe` (the process holding Windows credentials in memory) with access rights `0x1010`.
...
## How to Run
1. Clone this repo
2. Install dependencies: `pip3 install python-evtx`
3. Run: `python3 detect_evtx.py`
